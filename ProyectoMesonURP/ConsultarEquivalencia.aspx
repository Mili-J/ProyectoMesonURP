<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultarEquivalencia.aspx.cs" MasterPageFile="~/Master.Master" Inherits="ProyectoMesonURP.ConsultarEquivalencia" %>
         ...
         <asp:UpdatePanel ID="panelInsumo" runat="server">
             <ContentTemplate>
                  ...
                  <div class="form-horizontal" runat="server" style="background-color:#f5f6f7; border-radius:1%">
                   ...
                   <div class="form-group">
                       <asp:Button CssClass="btn btn-primary" ID="btnVolver" runat="server" Text="Volver" />
                   </div>
