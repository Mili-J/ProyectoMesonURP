                ...
                <div class="padding-top-30">
                    ...
                    <div class="form-group row col-md-8" runat="server" id="PanelMedida2" visible="false">
                        ...
                        <div class="col-sm-4 col-md-2">
                            <asp:TextBox ID="txtCantidadCo" runat="server" class="form-control" Text="1" Width="50px" />
                        </div>
                        <div class="col-sm-12 col-md-6">
                    ...
                    <div class="form-group row col-md-8" runat="server" id="PanelMedida3" visible="false">
                        ...
                        <div class="col-sm-4 col-md-2">
                            <asp:TextBox ID="TxtCantUn" runat="server" class="form-control" Text="1" Width="50px" Visible="false"/>
                        </div>
                    ...
                    <div class="form-group row col-md-8" runat="server" id="Cantmin" visible="false">
                        ...
                        <div class="col-sm-4 col-md-2">
                            <asp:TextBox ID="TxtCantmin" runat="server" class="form-control" Text="0" Width="50px"/>
                        </div>
