<%@ Page Title="Gestionar Insumo | Agregar" Language="C#" AutoEventWireup="true" CodeBehind="AgregarInsumo.aspx.cs" MasterPageFile="~/Master.Master" Inherits="ProyectoMesonURP.AgregarInsumo"%>
    ...
    <div class="women_main">
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            ...
            <p class="center-button" style="margin-top: 49px; margin-bottom: 44px;">
                <button type="button" name="sub-1" class="btn btn-primary" runat="server" id="btnRegistrar" onserverclick="btnRegistrar_ServerClick" ValidationGroup="insumo">Registrar</button>
