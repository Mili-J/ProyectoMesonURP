...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
         <div class="women_main">
                    ...
                    <div class="grids">
                      ...
                      <%--<ContentTemplate>--%>
                                    <asp:TextBox  id="txtBuscarReceta" runat="server" AutoPostBack="True" CssClass="form-control1" OnTextChanged="fNombreReceta_TextChanged" onkeypress="return soloLetras(event);"  placeholder="Buscar Receta ..."/> </asp:TextBox> 
							...
							<div class="col-md-4 col-xs-6">
								...
								<div class="product">
									<div class="product-img">
										<img src="data:image/png;base64,<%# Convert.ToBase64String((byte[]) DataBinder.Eval(Container.DataItem,"R_imagenReceta")) %>" alt="" class="sg-img" >
									...
									<div class="product-body">
											...
											<h3 class="product-name"><asp:Label ID="lblNombreReceta"  runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"R_nombreReceta") %>'></asp:Label></h3>
											<h4 class="product-price"><asp:Label ID="lblPorciones"  runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"R_numeroPorcion") %>'></asp:Label></h4>	
                                             <p class="product-category"><asp:Label ID="lblCategoria"  runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CR_nombreCategoria") %>'/> </p>
