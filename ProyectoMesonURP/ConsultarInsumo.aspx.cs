...
namespace ProyectoMesonURP
{
    public partial class ConsultarInsumo : System.Web.UI.Page
    {
        ...
        private void Lock() 
        {
            ...
            txtCantidadCo.ReadOnly = true;
            TxtCantUn.ReadOnly = true;
            TxtCantmin.ReadOnly = true;
            DDLMedida2.Enabled = false;
            if (CheckBox1.Checked) { CheckBox1.Visible = false; }
            else { PanelMedida3.Visible = false; }
